...
reqst_channel = environ.get('REQST_CHANNEL', '-1003525105249')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003579983148')).split()]  # For Multiple Id Use One Space Between Each.
